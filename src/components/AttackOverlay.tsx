    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
        ...
        <motion.svg
          ...
          height="500"
          viewBox="0 0 500 500"
          className="absolute -bottom-20 -right-20 text-white/5 rotate-180"
        ...
        {/* Dynamic Webs appearing on Block */}
        <motion.div
      ...
      >
        <div className="bg-[#0a0a14]/90 backdrop-blur-xl rounded-2xl border border-red-500/20 shadow-[0_0_40px_rgba(220,38,38,0.1)] overflow-hidden">
          {/* HUD Top Bar */}
          <div className="bg-red-600/10 border-b border-red-500/20 px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
              <span className="text-[10px] font-black uppercase tracking-[0.3em] text-red-500">Web_Arrest.protocol</span>
            </div>
          ...
          <div className="px-6 py-6">
            <div className="flex flex-col items-center text-center mb-6">
              <div className="w-12 h-12 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center justify-center mb-4 relative">
                ...
                <div className="absolute inset-0 bg-red-500/5 blur-lg rounded-full animate-pulse" />
              </div>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full h-11 bg-red-600 hover:bg-red-500 disabled:bg-red-900/50 text-white font-black uppercase tracking-[0.3em] text-[10px] rounded-xl transition-all shadow-lg active:scale-95 flex items-center justify-center gap-2 group"
              >
                {loading ? (
...
/* Helper Component for Animated Webs */
const WebSVG = ({ index }: { index: number }) => {
  const positions = [
    { top: '10%', left: '5%' },
    { top: '5%', right: '10%' },
    { bottom: '15%', left: '8%' },
  ...
  return (
    <motion.svg
      ...
      style={{
        position: 'absolute',
        ...pos,
        color: index % 2 === 0 ? 'rgba(239, 68, 68, 0.08)' : 'rgba(37, 99, 235, 0.08)'
      }}
      variants={{
